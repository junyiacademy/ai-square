    ...
    knowledge: [
      {
        code: "K1.1",
        summary:
          "AI systems use algorithms combining procedures with statistical inferences",
      },
      {
        code: "K1.2",
        summary:
          "Machines learn by inferring outputs from inputs with varying autonomy",
      },
      {
        code: "K1.3",
        summary:
          "Generative AI uses probabilities without authentic understanding",
      },
      {
        code: "K1.4",
        summary: "AI systems operate differently based on purpose",
      },
      {
        code: "K2.1",
        summary: "AI reflects human choices and labor practices",
      },
      {
        code: "K2.2",
        summary: "AI trains on vast datasets from various sources",
      },
      ...
      {
        code: "K3.2",
        summary: "AI predictions are based on probabilities, not certainties",
      },
