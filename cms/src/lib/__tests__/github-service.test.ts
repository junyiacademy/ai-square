...
describe('GitHubService', () => {
  ...
  describe('listFiles', () => {
    ...
    it('should handle API errors', async () => {
      ;(githubService as any).octokit.rest.repos.getContent.mockRejectedValueOnce(
        new Error('API Error')
      )

      await expect(githubService.listFiles()).rejects.toThrow('Failed to list files: API Error')
    })
  })
  ...
  describe('readFile', () => {
    ...
    it('should handle read errors', async () => {
      ...
      await expect(githubService.readFile('nonexistent.yaml')).rejects.toThrow('Failed to read file')
    })
  })

  describe('saveFile', () => {
    it('should save file to main branch', async () => {
      ;(githubService as any).octokit.rest.repos.createOrUpdateFileContents.mockResolvedValueOnce({
  ...
  describe('createBranch', () => {
    ...
    it('should handle branch creation errors', async () => {
      ...
      await expect(githubService.createBranch('new-feature')).rejects.toThrow('Failed to create branch')
    })
  })
  ...
  describe('createPullRequest', () => {
    ...
    it('should handle PR creation errors', async () => {
      ...
      await expect(githubService.createPullRequest(
        'feature-branch',
        'Test PR',
        'Test description'
