...
import { Loader2, Check, GitBranch, Save, GitPullRequestIcon, Sparkles } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-6">
          ...
          <p className="text-blue-100 mt-1">Processing your changes with intelligent automation</p>
        </div>
                ...
                <div className="flex-1">
                  ...
                  {step.id === 'create-branch' && step.status === 'completed' && branchName && (
                    <div className="mt-2 p-3 bg-blue-50 rounded-lg">
                      <p className="text-sm text-blue-700">
                        <span className="font-medium">Branch created:</span> {branchName}
                      </p>
                    </div>
                  )}
                  ...
                  {step.id === 'save-changes' && step.status === 'completed' && commitMessage && (
                    <div className="mt-2 p-3 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600 font-mono">{commitMessage}</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="mt-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
              <div className="border-t pt-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 max-h-64 overflow-y-auto">
                  <pre className="text-sm text-gray-700 whitespace-pre-wrap font-sans">{prDescription}</pre>
                </div>
              </div>
            </div>
          )}
