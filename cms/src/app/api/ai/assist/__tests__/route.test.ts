...
describe("/api/ai/assist", () => {
  const mockCompleteYAMLContent =
    vertexAI.completeYAMLContent as jest.MockedFunction<
      typeof vertexAI.completeYAMLContent
    >;
  const mockTranslateYAMLContent =
    vertexAI.translateYAMLContent as jest.MockedFunction<
      typeof vertexAI.translateYAMLContent
    >;
  const mockImproveYAMLContent =
    vertexAI.improveYAMLContent as jest.MockedFunction<
      typeof vertexAI.improveYAMLContent
    >;
  const mockMapKSAContent = vertexAI.mapKSAContent as jest.MockedFunction<
    typeof vertexAI.mapKSAContent
  >;
  ...
  describe("POST - translate action", () => {
    it("should translate YAML content successfully", async () => {
      ...
      expect(mockTranslateYAMLContent).toHaveBeenCalledWith(
        "scenario_info:\\n  title: Test",
      );
    });
  });
  ...
  describe("POST - improve action", () => {
    it("should improve YAML content successfully", async () => {
      ...
      expect(mockImproveYAMLContent).toHaveBeenCalledWith(
        "scenario_info:\\n  title: Basic Scenario",
      );
    });
  });
  ...
  describe("POST - map-ksa action", () => {
    it("should map KSA content successfully", async () => {
      ...
      expect(mockMapKSAContent).toHaveBeenCalledWith(
        "scenario_info:\\n  title: Test",
      );
    });
  });
  ...
  describe("POST - error handling", () => {
    ...
    it("should handle invalid action", async () => {
      ...
      expect(data.error).toBe(
        "Invalid action. Supported actions: complete, translate, improve, map-ksa",
      );
    });

    it("should handle AI service errors", async () => {
      mockCompleteYAMLContent.mockRejectedValue(
