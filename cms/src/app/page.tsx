...
import {
  ProcessingModal,
  ProcessingStep,
} from "@/components/cms/ProcessingModal";
...
export default function CmsPage() {
  ...
  useEffect(() => {
    ...
    (
      window as Window & { setOriginalContent?: typeof setOriginalContent }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      try {
        ...
        const messageData =
          (await messageResponse.json()) as CommitMessageResponse;
      ...
      if (wasOnMain) {
        ...
        if (prData.success) {
          ...
          setTimeout(() => {
            ...
            toast.className =
              "fixed top-6 right-6 toast-success z-[60] animate-in slide-in-from-right flex items-center gap-3";
  ...
  const handleSwitchToMain = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        const toast = document.createElement("div");
        toast.className =
          "fixed top-6 right-6 toast-success z-50 animate-in slide-in-from-right flex items-center gap-3";
