...
async function main() {
  ...
  try {
    ...
    console.log(
      `   Week-over-Week: ${stats.userGrowth.weekOverWeekGrowth.toFixed(1)}%`,
    );
    ...
    console.log(
      `   Retention: ${stats.engagement.retentionRate.toFixed(1)}%\n`,
    );
    ...
    console.log(
      "💡 To send this report to Slack, it will be sent automatically every Monday 09:00",
    );
