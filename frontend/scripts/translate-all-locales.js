...
const translations = {
  ...
  de: {
    ...
    welcomeMessage:
      "Ich bin hier, um Ihnen bei Ihrer KI-Kompetenzreise zu helfen. Fragen Sie mich nach Lernpfaden, PBL-Szenarien oder KI-Konzepten, die Sie besser verstehen möchten.",
    ...
    suggestedTopic3:
      "Was sind meine Schwächen und wie kann ich mich verbessern?",
  ...
  es: {
    ...
    welcomeMessage:
      "Estoy aquí para ayudarte en tu viaje de alfabetización en IA. Pregúntame sobre rutas de aprendizaje, escenarios PBL o cualquier concepto de IA que quieras entender mejor.",
  ...
  fr: {
    ...
    welcomeMessage:
      "Je suis ici pour vous aider dans votre parcours de littératie IA. Posez-moi des questions sur les parcours d'apprentissage, les scénarios PBL ou tout concept IA que vous souhaitez mieux comprendre.",
    inputPlaceholder:
    ...
    suggestedTopic3:
      "Quels sont mes points faibles et comment puis-je m'améliorer?",
    ...
    function translateObject(obj) {
      for (const key in obj) {
        if (typeof obj[key] === "string") {
          ...
          if (
            obj[key].includes(`[${langCode.toUpperCase()}]`) ||
