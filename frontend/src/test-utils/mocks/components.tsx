...
export const heroIconsOutlineMock = {
  ...
  CpuChipIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="cpu-chip-icon">
      <path />
    </svg>
  ),
  PuzzlePieceIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="puzzle-piece-icon">
      <path />
    </svg>
  ),
  ...
  Cog6ToothIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="cog-6-tooth-icon">
      <path />
    </svg>
  ),
};
...
export const heroIconsSolidMock = {
  TrophyIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="trophy-icon-solid">
      <path />
    </svg>
  ),
  SparklesIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="sparkles-icon-solid">
      <path />
    </svg>
  ),
  CpuChipIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="cpu-chip-icon-solid">
      <path />
    </svg>
  ),
  PuzzlePieceIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="puzzle-piece-icon-solid">
      <path />
    </svg>
  ),
  GlobeAltIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="globe-alt-icon-solid">
      <path />
    </svg>
  ),
  StarIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="star-icon-solid">
      <path />
    </svg>
  ),
  ChartBarIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="chart-bar-icon-solid">
      <path />
    </svg>
  ),
  UserIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="user-icon-solid">
      <path />
    </svg>
  ),
  CheckIcon: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="check-icon-solid">
      <path />
    </svg>
  ),
};
...
export const nextLinkMock = ({ href, children, className, ...props }: any) => (
...
export const setupLucideIconsMocks = () => {
  jest.mock("lucide-react", () => ({
    ...
    Cpu: ({ className }: { className?: string }) => (
      <svg className={className} data-testid="cpu-icon">
        <path />
      </svg>
    ),
    ...
    Rocket: ({ className }: { className?: string }) => (
      <svg className={className} data-testid="rocket-icon">
        <path />
      </svg>
    ),
