...
describe("Type Converters", () => {
  ...
  describe("toRecord", () => {
    it("should convert to Record<string, string>", () => {
      ...
      expect(toRecord({ a: "hello", b: "world" })).toEqual({
        a: "hello",
        b: "world",
      });
  ...
  describe("toMultilingual", () => {
    it("should convert to multilingual object", () => {
      ...
      expect(toMultilingual({ en: "Hello", zh: "你好" })).toEqual({
        en: "Hello",
        zh: "你好",
      });
      expect(toMultilingual('{"en":"Test","fr":"Teste"}')).toEqual({
        en: "Test",
        fr: "Teste",
      });
  ...
  describe("parseJSON", () => {
    it("should safely parse JSON", () => {
      ...
      expect(parseJSON("invalid", { default: true })).toEqual({
        default: true,
      });
    });
  });
