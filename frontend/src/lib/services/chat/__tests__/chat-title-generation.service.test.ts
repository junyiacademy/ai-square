...
import { ChatTitleGenerationService, type ChatMessage } from '../chat-title-generation.service';
  ...
  describe('generateTitle', () => {
    it('should generate title from multiple messages', async () => {
      const messages: ChatMessage[] = [
        { id: '1', role: 'user', content: 'What is machine learning?', timestamp: '2024-01-01T00:00:00Z' },
        { id: '2', role: 'assistant', content: 'Machine learning is...', timestamp: '2024-01-01T00:01:00Z' },
        { id: '3', role: 'user', content: 'How does it work?', timestamp: '2024-01-01T00:02:00Z' }
      ];
    ...
    it('should truncate long messages to 150 chars', async () => {
      ...
      const messages: ChatMessage[] = [
        { id: '1', role: 'user', content: longMessage, timestamp: '2024-01-01T00:00:00Z' },
    ...
    it('should format prompt correctly', async () => {
      const messages: ChatMessage[] = [
        ...
        { id: '2', role: 'assistant', content: 'AI is artificial intelligence', timestamp: '2024-01-01T00:01:00Z' }
      ];
