...
describe("EvaluationTranslationService", () => {
  ...
  describe("getOrTranslateFeedback", () => {
    it("should return existing translation if available", async () => {
      ...
      expect(
        TranslationService.prototype.translateFeedback,
    ...
    it("should translate when requested language not available", async () => {
      ...
      (
        TranslationService.prototype.translateFeedback as jest.Mock
      ).mockResolvedValue("做得好！");
      ...
      expect(
        TranslationService.prototype.translateFeedback,
      ).toHaveBeenCalledWith("Good work!", "zhTW", "software_engineer");
    ...
    it("should use fallback on translation error", async () => {
      ...
      (TranslationService.getFeedbackByLanguage as jest.Mock).mockReturnValue(
        "Good work!",
      );
  ...
  describe("extractExistingVersions", () => {
    it("should extract from feedbackData first", () => {
      ...
      const versions =
        EvaluationTranslationService.extractExistingVersions(evaluation);
