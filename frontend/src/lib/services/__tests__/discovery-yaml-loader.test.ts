...
describe("DiscoveryYAMLLoader", () => {
  ...
  describe("load", () => {
    it("should load YAML file successfully", async () => {
      const result = await loader.load(
        "software_engineer/software_engineer_en",
      );
  ...
  describe("getPathMetadata", () => {
    it.skip("should return metadata from loaded path", async () => {
      ...
      // Mock interference causes metadata to be null sometimes
  ...
  describe("getSkillDependencies", () => {
    it("should extract skill dependencies correctly", () => {
      ...
      expect(dependencies.get("system_design")).toEqual([
        "programming_basics",
        "data_structures",
      ]);
  ...
  describe("achievement and quest handling", () => {
    it("should handle achievements correctly", () => {
      ...
      expect(
        dataWithAchievements.achievements?.mastery[0].skills_required,
      ).toContain("programming_basics");
  ...
  describe("daily challenges", () => {
    it("should handle daily challenges structure", () => {
      ...
      expect(dataWithChallenges.daily_challenges?.categories[0].type).toBe(
        "coding",
      );
    });
  });
  ...
  describe("singleton instance", () => {
    it("should export singleton instance", () => {
      ...
      const {
        discoveryYAMLLoader,
        DiscoveryYAMLLoader: LoaderClass,
      } = require("../discovery-yaml-loader");
