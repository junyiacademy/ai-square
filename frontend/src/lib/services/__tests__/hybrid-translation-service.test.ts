...
describe("HybridTranslationService", () => {
  ...
  beforeEach(() => {
    ...
    (getScenarioStorageService as jest.Mock).mockReturnValue(
      mockStorageService,
    );
  ...
  describe("getScenario", () => {
    it("should return English scenario directly from storage", async () => {
      ...
      expect(mockStorageService.getScenario).toHaveBeenCalledWith(
        "test-scenario",
      );
    });
    ...
    it("should handle storage service errors", async () => {
      mockStorageService.getScenario.mockRejectedValue(
        new Error("Storage error"),
      );

      await expect(service.getScenario("test-scenario", "en")).rejects.toThrow(
        "Storage error",
      );
    });
    ...
    it("should clear cache on error", async () => {
      ...
      // Second call fails
      await expect(
        service.getScenario("error-scenario", "en"),
      ).rejects.toThrow();
  ...
  describe("listScenarios", () => {
    ...
    it("should handle list errors", async () => {
      ...
      await expect(service.listScenarios("en")).rejects.toThrow("List failed");
    });
  });
  ...
  describe("getProgram", () => {
    it("should get program from storage service", async () => {
      ...
      expect(mockStorageService.getProgram).toHaveBeenCalledWith(
        "scenario-1",
        "program-1",
      );
    });
  ...
  describe("getTask", () => {
    it("should get task from storage service", async () => {
      ...
      expect(mockStorageService.getTask).toHaveBeenCalledWith(
        "scenario-1",
        "program-1",
        "task-1",
      );
  ...
  describe("Cache management", () => {
    ...
    it("should clear list cache on error", async () => {
      ...
      // Second call fails
      await expect(service.listScenarios("zh")).rejects.toThrow();
