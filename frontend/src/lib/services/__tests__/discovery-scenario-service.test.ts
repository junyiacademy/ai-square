...
describe("DiscoveryScenarioService", () => {
  ...
  const mockYAMLData = {
    ...
    metadata: {
      ...
      long_description:
        "Learn to create engaging content for various platforms",
      estimated_hours: 20,
    ...
    starting_scenario: {
      ...
      description:
        "Create your first piece of content. Start with a simple blog post.",
      initial_tasks: [
        "understand_audience",
        "create_content_plan",
        "write_first_draft",
  ...
  describe("createScenarioFromYAML", () => {
    it("should create scenario from YAML data", async () => {
      const result = await discoveryScenarioService.createScenarioFromYAML(
        "content_creator",
        "en",
      );
    ...
    it("should fallback to English when language file not found", async () => {
      ...
      await discoveryScenarioService.createScenarioFromYAML(
        "content_creator",
        "zh",
      );
    ...
    it("should create task templates from initial tasks", async () => {
      ...
      const taskTemplates = (mockScenarioRepo.create as jest.Mock).mock
        .calls[0][0].taskTemplates;
  ...
  describe("findOrCreateScenarioByCareerType", () => {
    it("should return existing scenario if found", async () => {
      ...
      const result =
        await discoveryScenarioService.findOrCreateScenarioByCareerType(
          "content_creator",
        );
  ...
  describe("listAvailableCareerTypes", () => {
    ...
    it("should handle readdir errors", async () => {
      ...
      await expect(
        discoveryScenarioService.listAvailableCareerTypes(),
  ...
  describe("difficulty handling", () => {
    it("should use first difficulty from range", async () => {
      ...
      const createdScenario = (mockScenarioRepo.create as jest.Mock).mock
        .calls[0][0];
