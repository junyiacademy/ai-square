...
describe("PostgreSQLUserRepository", () => {
  ...
  describe("addAchievement", () => {
    ...
    it("should handle achievement not found error", async () => {
      ...
      await expect(
        repository.addAchievement("user-123", "non-existent-achievement"),
    ...
    it("should rollback transaction on error", async () => {
      ...
      await expect(
        repository.addAchievement("user-123", "achievement-123"),
  ...
  describe("saveAssessmentSession", () => {
    it("should save assessment session to evaluations table", async () => {
      ...
      const result = await repository.saveAssessmentSession(
        "user-123",
        sessionData,
      );
  ...
  describe("saveUserData", () => {
    it("should save complete user data with transaction", async () => {
      ...
      const result = await repository.saveUserData(
        "test@example.com",
        userDataInput,
      );
    ...
    it("should rollback transaction on error", async () => {
      ...
      await expect(
        repository.saveUserData("test@example.com", userDataInput),
