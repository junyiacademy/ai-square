...
describe("PostgreSQLProgramRepository", () => {
  ...
  const mockDBProgram: DBProgram = {
    ...
    xp_earned: 150,
    badges_earned: [
      { badgeId: "first-task", earnedAt: "2024-01-01" },
      { badgeId: "problem-solver", earnedAt: "2024-01-02" },
    ],
  ...
  describe("findById", () => {
    ...
    it("should handle database errors", async () => {
      ...
      await expect(repository.findById("program-123")).rejects.toThrow(
        "Database error",
      );
    });
  });
  ...
  describe("create", () => {
    ...
    it("should handle create errors", async () => {
      ...
      await expect(repository.create(newProgram)).rejects.toThrow(
        "Insert failed",
      );
    });
  });
  ...
  describe("update", () => {
    ...
    it("should handle empty updates", async () => {
      ...
      await expect(repository.update("program-123", updates)).rejects.toThrow(
        "No fields to update",
      );
    });
  ...
  describe("Complex queries", () => {
    it("should handle programs with different modes", async () => {
      ...
      const assessmentProgram = {
        ...mockDBProgram,
        id: "prog-2",
        mode: "assessment",
      };
      const discoveryProgram = {
        ...mockDBProgram,
        id: "prog-3",
        mode: "discovery",
      };
