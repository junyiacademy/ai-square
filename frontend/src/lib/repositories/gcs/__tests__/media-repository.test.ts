...
describe('GCSMediaRepository', () => {
  ...
  describe('uploadFile', () => {
    it('should upload file successfully and return public URL', async () => {
      ...
      (mockFile.makePublic as jest.Mock).mockResolvedValue([{}]);
  ...
  describe('getFileUrl', () => {
    it('should return public URL for public files', async () => {
      (mockFile.exists as jest.Mock).mockResolvedValue([true]);
    ...
    it('should return signed URL for private files', async () => {
      ...
      (mockFile.getSignedUrl as jest.Mock).mockResolvedValue(['https://signed-url']);
  ...
  describe('deleteFile', () => {
    it('should delete file successfully', async () => {
      (mockFile.delete as jest.Mock).mockResolvedValue([{}]);
    ...
    it('should return false on deletion error', async () => {
      (mockFile.delete as jest.Mock).mockRejectedValue(new Error('Delete failed'));
  ...
  describe('listFiles', () => {
    it('should list files with metadata', async () => {
      ...
      (mockBucket.getFiles as jest.Mock).mockResolvedValue([mockFiles as any, {}, {}]);
  ...
  describe('getUploadUrl', () => {
    it('should generate pre-signed upload URL', async () => {
      (mockFile.getSignedUrl as jest.Mock).mockResolvedValue(['https://signed-upload-url']);
  ...
  describe('copyFile', () => {
    it('should copy file successfully', async () => {
      (mockFile.copy as jest.Mock).mockResolvedValue([{}, {}]);
      const getFileUrlSpy = jest.spyOn(repository, 'getFileUrl');
    ...
    it('should handle copy errors', async () => {
      (mockFile.copy as jest.Mock).mockRejectedValue(new Error('Copy failed'));
  ...
  describe('exists', () => {
    ...
    it('should return false on error', async () => {
      (mockFile.exists as jest.Mock).mockRejectedValue(new Error('Check failed'));
  ...
  describe('getMetadata', () => {
    it('should get file metadata successfully', async () => {
      ...
      (mockFile.getMetadata as jest.Mock).mockResolvedValue([mockMetadata]);
    ...
    it('should handle metadata errors', async () => {
      (mockFile.getMetadata as jest.Mock).mockRejectedValue(new Error('Metadata failed'));
  ...
  describe('setMetadata', () => {
    it('should set custom metadata successfully', async () => {
      (mockFile.setMetadata as jest.Mock).mockResolvedValue([{}]);
    ...
    it('should handle set metadata errors', async () => {
      (mockFile.setMetadata as jest.Mock).mockRejectedValue(new Error('Set metadata failed'));
  ...
  describe('downloadFile', () => {
    it('should download file content successfully', async () => {
      ...
      (mockFile.download as jest.Mock).mockResolvedValue([mockContent]);
  ...
  describe('isPublic (private method)', () => {
    ...
    it('should handle missing ACL', async () => {
      (mockFile.exists as jest.Mock).mockResolvedValue([true]);
      (mockFile.getMetadata as jest.Mock).mockResolvedValue([{}]); // No ACL
      (mockFile.getSignedUrl as jest.Mock).mockResolvedValue(['https://signed-url']);
