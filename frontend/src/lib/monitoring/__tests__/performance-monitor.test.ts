...
describe("performance-monitor", () => {
  ...
  describe("getPerformanceReport", () => {
    ...
    it("generates alerts for slow endpoints", () => {
      ...
      const report = getPerformanceReport();
      const slowAlert = report.alerts.find((a) =>
        a.includes("Slow response time"),
      );
    ...
    it("generates alerts for high error rates", () => {
      ...
      const report = getPerformanceReport();
      const errorAlert = report.alerts.find((a) =>
        a.includes("High error rate"),
      );
    ...
    it("generates alerts for low cache hit rate on GET endpoints", () => {
      ...
      const report = getPerformanceReport();
      const cacheAlert = report.alerts.find((a) =>
        a.includes("Low cache hit rate"),
      );
    ...
    it("does not alert on low cache for non-GET methods", () => {
      ...
      const report = getPerformanceReport();
      const cacheAlert = report.alerts.find(
        (a) => a.includes("Low cache hit rate") && a.includes("/api/post"),
      );
