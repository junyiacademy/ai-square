    ...
    <div className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
      <div className="flex justify-around">
        ...
        >
          ...
          <span className="text-xs font-medium">{t("learn.progress")}</span>
        </button>
        ...
        >
          ...
          <span className="text-xs font-medium">{t("learn.taskInfo")}</span>
        </button>
        ...
        >
          ...
          <span className="text-xs font-medium">{t("learn.chat")}</span>
        </button>
      </div>
    </div>
  );
