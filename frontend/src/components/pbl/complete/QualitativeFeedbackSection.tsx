...
/**
 * Qualitative Feedback Section Component
 *
 * Displays personalized feedback including overall assessment,
 * strengths, areas for improvement, next steps, and encouragement.
 */
