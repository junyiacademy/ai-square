...
describe("QualitativeFeedbackSection", () => {
  ...
  it("renders overall assessment", () => {
    ...
    expect(
      screen.getByText("Great work on this scenario!"),
    ).toBeInTheDocument();
  });
  ...
  it("renders strengths section", () => {
    ...
    expect(
      screen.getByText("You demonstrated excellent problem-solving skills."),
    ).toBeInTheDocument();
  });
  ...
  it("renders strength examples when provided", () => {
    ...
    expect(
      screen.getByText(/You broke down complex problems effectively\./),
    ).toBeInTheDocument();
  });
  ...
  it("renders areas for improvement", () => {
    ...
    expect(
      screen.getByText("Consider planning your approach before starting."),
    ).toBeInTheDocument();
  });
  ...
  it("renders suggestions when provided", () => {
    ...
    expect(
      screen.getByText("Try creating an outline first."),
    ).toBeInTheDocument();
  });
  ...
  it("does not show encouragement when not provided", () => {
    const feedbackWithoutEncouragement = {
      ...mockFeedback,
