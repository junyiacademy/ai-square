...
import type { AssessmentResult, UserProgress, PBLHistory, RecommendedScenario, User } from '@/types/chat';
      ...
      <div className="p-4">
        ...
        <div className="space-y-4">
          {currentUser && assessmentResult && (
            <UserProgressCard assessmentResult={assessmentResult} userProgress={userProgress} />
          )}
