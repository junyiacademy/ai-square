...
jest.mock("lucide-react", () => ({
  ...
  Zap: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="zap-icon">
      <path />
    </svg>
  ),
  ...
  Flame: ({ className }: { className?: string }) => (
    <svg className={className} data-testid="flame-icon">
      <path />
    </svg>
  ),
...
describe("WelcomeScreen", () => {
  ...
  beforeEach(() => {
    ...
    mockT.mockImplementation((key: string, options?: any) => {
      const translations: Record<string, any> = {
        ...
        "welcomeScreen.features.immersive.description":
        ...
        "welcomeScreen.features.real_time.description":
          "Instant learning insights",
      };
  ...
  it("should render title and subtitle from translations", async () => {
    ...
    expect(screen.getByText("Welcome to AI Discovery")).toBeInTheDocument();
    expect(
      screen.getByText("Embark on an AI-powered learning journey"),
    ).toBeInTheDocument();
  });
  ...
  it("should render all feature cards", async () => {
    ...
    expect(
      screen.getByText("Engaging learning environment"),
    ).toBeInTheDocument();
  ...
  it("should render particles background elements", async () => {
    ...
    const particleContainer = screen
      .getByText("Welcome to AI Discovery")
      .closest(".relative");
  ...
  it("should handle empty phrases array gracefully", async () => {
    ...
    expect(
      screen.getByRole("button", { name: /fallback/i }),
    ).toBeInTheDocument();
  });
  ...
  it("should clean up intervals on unmount", async () => {
    const { unmount } = renderWithProviders(
      <WelcomeScreen onStartJourney={mockOnStartJourney} />,
    );
  ...
  it("should render bottom CTA section", async () => {
    ...
    expect(
      screen.getByText("Ready to Redefine Your Future"),
    ).toBeInTheDocument();
  ...
  it("should handle feature card interactions", async () => {
    ...
    const immersiveCard = screen
      .getByText("Immersive Experience")
      .closest("div");
