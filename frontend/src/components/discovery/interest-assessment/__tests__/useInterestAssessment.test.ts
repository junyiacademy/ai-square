...
describe('useInterestAssessment', () => {
  const mockQuestions: Question[] = [
    {
      ...
      text: 'Question 1',
      options: [
        { id: 'q1-opt1', text: 'Option 1', weight: { tech: 1, creative: 0, business: 0 } },
        { id: 'q1-opt2', text: 'Option 2', weight: { tech: 0, creative: 1, business: 0 } },
      ]
    },
    {
      id: 'q2',
      text: 'Question 2',
      options: [
        { id: 'q2-opt1', text: 'Option 1', weight: { tech: 0, creative: 0, business: 1 } },
        { id: 'q2-opt2', text: 'Option 2', weight: { tech: 1, creative: 0, business: 0 } },
      ]
    }
  ];
  ...
  it('should initialize with first question', () => {
    const { result } = renderHook(() =>
      useInterestAssessment({ questions: mockQuestions, onComplete: mockOnComplete })
    );
