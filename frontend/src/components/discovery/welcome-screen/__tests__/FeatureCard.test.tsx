...
describe("FeatureCard", () => {
  ...
  it("should display description", () => {
    render(<FeatureCard {...mockProps} />);
    expect(
      screen.getByText("Test description for feature"),
    ).toBeInTheDocument();
  });
  ...
  it("should handle long titles gracefully", () => {
    render(
      <FeatureCard
        {...mockProps}
        title="Very Long Feature Title That Spans Multiple Lines"
      />,
    );
    expect(
      screen.getByText("Very Long Feature Title That Spans Multiple Lines"),
    ).toBeInTheDocument();
  });

  it("should handle long descriptions gracefully", () => {
    const longDescription =
      "This is a very long description that should wrap properly and still be displayed correctly in the feature card component without breaking the layout or causing any issues.";
