...
describe('DesktopNavigation', () => {
  ...
  const secondaryNavLinks: NavLink[] = [
    ...
    { href: '/history', label: 'history', disabled: true, tooltip: 'comingSoon' },
    { href: '/discovery/overview', label: 'discovery', disabled: true, tooltip: 'comingSoon' },
  ];
  ...
  describe('Edge Cases', () => {
    ...
    it('handles links without href', () => {
      const linksWithoutHref: NavLink[] = [
        { label: 'no-href-link' },
      ];
