...
describe("RightPanel Component", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should render with collapsed state", () => {
      const { container } = render(
        <RightPanel {...mockProps} rightPanelCollapsed={true} />,
      );
      const panel = container.firstChild as HTMLElement;
  ...
  describe("Action Buttons", () => {
    ...
    it('should show "發布中..." when publishing', () => {
      render(
        <RightPanel {...mockProps} hasChanges={true} isPublishing={true} />,
      );
  ...
  describe("Chat Messages Display", () => {
    it("should render all chat messages", () => {
      ...
      expect(
        screen.getByText("✅ 已將標題更新為「AI基礎課程」"),
      ).toBeInTheDocument();
    });
    ...
    it("should handle empty chat messages", () => {
      const { container } = render(
        <RightPanel {...mockProps} chatMessages={[]} />,
      );
  ...
  describe("Chat Input", () => {
    ...
    it("should call handleSendMessage when send button clicked", () => {
      const { container } = render(
        <RightPanel {...mockProps} inputMessage="Test message" />,
      );
    ...
    it("should disable send button when processing", () => {
      const { container } = render(
        <RightPanel {...mockProps} isProcessing={true} inputMessage="Test" />,
      );
      const sendButton = container.querySelector(
        'input[placeholder="輸入指令..."]',
      )?.nextElementSibling as HTMLButtonElement;
    ...
    it("should disable send button when input is empty", () => {
      const { container } = render(
        <RightPanel {...mockProps} inputMessage="" />,
      );
      const sendButton = container.querySelector(
        'input[placeholder="輸入指令..."]',
      )?.nextElementSibling as HTMLButtonElement;
    ...
    it("should not show chat input when collapsed", () => {
      render(<RightPanel {...mockProps} rightPanelCollapsed={true} />);
      expect(
        screen.queryByPlaceholderText("輸入指令..."),
