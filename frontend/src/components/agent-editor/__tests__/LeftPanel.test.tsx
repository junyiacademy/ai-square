...
describe('LeftPanel Component', () => {
  ...
  describe('Rendering', () => {
    it('should render with collapsed state', () => {
      const { container } = render(<LeftPanel {...mockProps} leftPanelCollapsed={true} />);
  ...
  describe('Change Status Display', () => {
    ...
    it('should show change count when has changes', () => {
      ...
      render(<LeftPanel {...mockProps} hasChanges={true} getChangeSummary={getChangeSummary} />);
    ...
    it('should not show change count text when collapsed', () => {
      ...
      render(<LeftPanel {...mockProps} leftPanelCollapsed={true} hasChanges={true} getChangeSummary={getChangeSummary} />);
