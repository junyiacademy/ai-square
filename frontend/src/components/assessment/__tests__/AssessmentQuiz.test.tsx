...
const mockQuestions: AssessmentQuestion[] = [
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "Which approach is most effective when using AI for creative writing?",
    options: {
...
describe("AssessmentQuiz", () => {
  ...
  it("renders quiz interface correctly", async () => {
    ...
    expect(
      screen.getByText("Provide clear, specific prompts with context"),
    ).toBeInTheDocument();
  });
  ...
  it("completes quiz on last question", async () => {
    ...
    fireEvent.click(
      screen.getByText(
        "Use AI as a collaborative partner for brainstorming and refinement",
      ),
    );
    fireEvent.click(screen.getByText("Submit"));
