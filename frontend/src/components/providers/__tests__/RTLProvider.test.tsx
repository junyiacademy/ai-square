...
describe("RTLProvider", () => {
  ...
  it("should handle undefined children", async () => {
    ...
    const { container } = renderWithProviders(
      <RTLProvider>{undefined}</RTLProvider>,
    );
  ...
  it("should handle string children", async () => {
    ...
    renderWithProviders(<RTLProvider>Plain text content</RTLProvider>);
  ...
  it("should handle number children", async () => {
    ...
    renderWithProviders(<RTLProvider>{42}</RTLProvider>);
