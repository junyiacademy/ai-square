      ...
      <div className="bg-white rounded-lg p-4 space-y-4">
        ...
        <div>
          ...
          {editingField === `task.${task.id}.title` ? (
            ...
            <div
              onClick={() => onStartEditing(`task.${task.id}.title`, task.title?.[language] || task.title?.en || '')}
        ...
        <div>
          ...
          {editingField === `task.${task.id}.description` ? (
            ...
            <div
              onClick={() => onStartEditing(`task.${task.id}.description`, task.description?.[language] || task.description?.en || '')}
