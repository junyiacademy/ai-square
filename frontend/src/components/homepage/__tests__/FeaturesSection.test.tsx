...
describe("FeaturesSection", () => {
  ...
  it("should render all feature cards", () => {
    ...
    expect(
      screen.getByText("features.items.personalizedLearning.title"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("features.items.personalizedLearning.description"),
    ).toBeInTheDocument();

    expect(
      screen.getByText("features.items.multilingualSupport.title"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("features.items.multilingualSupport.description"),
    ).toBeInTheDocument();

    expect(
      screen.getByText("features.items.realTimeAI.title"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("features.items.realTimeAI.description"),
    ).toBeInTheDocument();

    expect(
      screen.getByText("features.items.comprehensiveAssessment.title"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("features.items.comprehensiveAssessment.description"),
    ).toBeInTheDocument();

    expect(
      screen.getByText("features.items.interactiveTasks.title"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("features.items.interactiveTasks.description"),
    ).toBeInTheDocument();

    expect(
      screen.getByText("features.items.progressTracking.title"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("features.items.progressTracking.description"),
    ).toBeInTheDocument();
  });
