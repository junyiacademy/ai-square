  ...
  useTranslation: () => ({
    t: (key: string) => {
      const translations: Record<string, string> = {
        ...
        "howItWorks.steps.assessment.description":
          "Complete our AI literacy assessment to identify your current level",
        "howItWorks.steps.personalized.title": "Get Personalized Path",
        "howItWorks.steps.personalized.description":
          "Receive a customized learning pathway based on your needs",
        "howItWorks.steps.learn.title": "Learn with AI",
        "howItWorks.steps.learn.description":
          "Engage with interactive scenarios and AI-powered tutoring",
        "howItWorks.steps.track.title": "Track Progress",
        "howItWorks.steps.track.description":
          "Monitor your growth and earn certifications",
      };
...
describe("HowItWorksSection", () => {
  ...
  it("renders step descriptions", async () => {
    ...
    expect(
      screen.getByText("Monitor your growth and earn certifications"),
    ).toBeInTheDocument();
  });
