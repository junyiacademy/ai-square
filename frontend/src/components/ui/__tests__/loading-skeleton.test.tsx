...
import { LoadingSkeleton, LoadingCard, LoadingAccordion } from '../loading-skeleton'
...
describe('LoadingSkeleton Components', () => {
  describe('LoadingSkeleton base component', () => {
    ...
    it('renders with custom className', () => {
      const { container } = render(<LoadingSkeleton className="custom-class h-10" />)
    ...
    it('renders with custom className for width and height', () => {
      const { container } = render(<LoadingSkeleton className="w-[200px] h-[50px]" />)
    ...
    it('renders circular variant with className', () => {
      const { container } = render(<LoadingSkeleton className="rounded-full" />)
    ...
    it('renders without rounded corners using className', () => {
      const { container } = render(<LoadingSkeleton className="rounded-none" />)
  ...
  describe('LoadingAccordion', () => {
    ...
    it('renders each accordion item with correct structure', () => {
      ...
      const firstItem = container.querySelector('.bg-gradient-to-r') as HTMLElement
      expect(firstItem).toHaveClass('from-blue-100', 'to-purple-100', 'px-6', 'py-4', 'rounded-lg', 'shadow')
    ...
    it('renders chevron skeleton with correct classes', () => {
      ...
      const firstItem = container.querySelector('.bg-gradient-to-r') as HTMLElement
      const chevronSkeleton = firstItem.querySelector('.h-6.w-6') as HTMLElement
