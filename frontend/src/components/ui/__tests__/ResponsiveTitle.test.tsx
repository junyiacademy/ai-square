...
describe("ResponsiveTitle", () => {
  ...
  it("adjusts font size for very long titles (> 40 chars)", async () => {
    const veryLongTitle =
      "This is an extremely long title that definitely exceeds forty characters and should use smaller font";
  ...
  it("updates font size when children change", async () => {
    ...
    const veryLongTitle =
      "This title is much longer than forty characters and should trigger smaller font size";
  ...
  it("handles empty className prop", async () => {
    renderWithProviders(
      <ResponsiveTitle className="">Empty Class</ResponsiveTitle>,
    );
