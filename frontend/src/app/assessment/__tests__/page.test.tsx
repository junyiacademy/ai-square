...
const mockT = jest.fn((key) => {
  const translations: Record<string, string> = {
    ...
    "assessment.intro.description":
      "This assessment will evaluate your understanding across four key AI literacy domains.",
...
describe("AssessmentPage", () => {
          ...
          questions: [
            {
              ...
              question:
                "What is the most effective way to get better results from an AI chatbot?",
              options: {
              ...
              correct_answer: "b",
              explanation:
                "Clear, specific prompts with context help AI understand exactly what you need.",
              ksa_mapping: {
                knowledge: ["K1.1", "K1.2"],
                skills: ["S1.1"],
                attitudes: ["A1.1"],
  ...
  it("renders intro screen after loading", async () => {
    ...
    await waitFor(() => {
      ...
      expect(
        screen.getByText("Evaluate your AI literacy across four key domains"),
      ).toBeInTheDocument();
  ...
  it("allows retaking assessment", async () => {
    ...
    // Retake assessment
    const retakeButton =
      screen.getByText(/retake/i) || screen.getAllByRole("button")[0];
