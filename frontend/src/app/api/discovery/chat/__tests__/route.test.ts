  ...
  describe('POST', () => {
    ...
    describe('Request Validation', () => {
      ...
      it('should handle context with missing properties gracefully', async () => {
        ...
        expect(body.response).toBe('抱歉，我暫時無法處理你的訊息。請稍後再試，或者繼續探索當前的任務！💪');
      });
    ...
    describe('Successful Responses', () => {
      it('should return AI response when successful', async () => {
        const aiResponse = '好的！我很樂意協助你學習 Python。讓我們從基礎開始吧！🐍';
        mockModel.generateContent.mockResolvedValue({
          response: {
            candidates: [{
              content: {
      ...
      it('should handle context with all required fields', async () => {
        ...
        const complexContext = {
          ...
          taskIndex: 3,
          totalTasks: 8,
          currentTaskDescription: 'Understanding neural networks and backpropagation',
          taskProgress: 45,
          completedTasks: 2,
          skills: ['Python', 'TensorFlow', 'Mathematics', 'Statistics', 'Deep Learning']
        };
    ...
    describe('Edge Cases', () => {
      ...
      it('should handle context with special characters', async () => {
        ...
        const contextWithSpecialChars = {
          ...
          currentTaskDescription: 'Learn about smart pointers: unique_ptr, shared_ptr, & weak_ptr'
        };
