...
describe("/api/discovery/scenarios/my", () => {
  ...
  describe("Authentication", () => {
    it("should return 401 when user is not authenticated", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/discovery/scenarios/my",
      );
  ...
  describe("Localization", () => {
    ...
    it("should return localized content based on lang parameter", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/discovery/scenarios/my?lang=zhTW",
      );
      const response = await GET(request);
    ...
    it("should handle zh-TW language mapping", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/discovery/scenarios/my?lang=zh-TW",
      );
      const response = await GET(request);
    ...
    it("should fallback to English for unavailable language", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/discovery/scenarios/my?lang=fr",
      );
      const response = await GET(request);
  ...
  describe("Error Handling", () => {
    ...
    it("should handle scenario repository errors", async () => {
      ...
      mockScenarioRepo.findById.mockRejectedValue(
        new Error("Scenario query failed"),
      );
