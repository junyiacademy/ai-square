...
describe('/api/pbl/programs/[id]', () => {
  ...
  describe('GET', () => {
    ...
    it('should return 401 for unauthenticated requests', async () => {
      ...
      const response = await GET(request, { params: { id: 'prog123' } })
  ...
  describe('PUT', () => {
    it('should return 401 for unauthenticated requests', async () => {
      ...
      const response = await PUT(request, { params: { id: 'prog123' } })
  ...
  describe('DELETE', () => {
    it('should return 401 for unauthenticated requests', async () => {
      ...
      const response = await DELETE(request, { params: { id: 'prog123' } })
