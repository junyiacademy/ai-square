...
>;
const mockGetProgramRepository =
  repositoryFactory.getProgramRepository as jest.MockedFunction<
    typeof repositoryFactory.getProgramRepository
  >;
const mockGetTaskRepository =
  repositoryFactory.getTaskRepository as jest.MockedFunction<
    typeof repositoryFactory.getTaskRepository
  >;
const mockGetEvaluationRepository =
  repositoryFactory.getEvaluationRepository as jest.MockedFunction<
    typeof repositoryFactory.getEvaluationRepository
  >;
const mockGetUserRepository =
  repositoryFactory.getUserRepository as jest.MockedFunction<
  ...
  describe("GET", () => {
    it("should return 401 for unauthenticated requests", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/pbl/completion?scenarioId=scenario1",
      );
    ...
    it("should retrieve completion data for authenticated users", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/pbl/completion?programId=prog1&scenarioId=scenario1",
      );
    ...
    it("should return 404 for non-existent program", async () => {
      ...
      mockUserRepo.findByEmail.mockResolvedValue(
        createMockUser({ id: "user123", email: "test@example.com" }),
      );
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/pbl/completion?programId=invalid&scenarioId=scenario1",
      );
