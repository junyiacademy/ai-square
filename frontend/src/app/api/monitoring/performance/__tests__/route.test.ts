...
describe('/api/monitoring/performance', () => {
  describe('GET', () => {
    ...
    it('should return metrics for specific endpoint', async () => {
      const request = new NextRequest('http://localhost:3000/api/monitoring/performance?endpoint=api/test&method=GET');
      const response = await GET(request);
    ...
    it('should return 404 when endpoint metrics not found', async () => {
      const request = new NextRequest('http://localhost:3000/api/monitoring/performance?endpoint=nonexistent');
      const response = await GET(request);
    ...
    it('should validate URL parsing', async () => {
      const request = new NextRequest('http://localhost:3000/api/monitoring/performance?invalid=param');
      const response = await GET(request);
  ...
  describe('Error handling', () => {
    ...
    it('should handle malformed URLs gracefully', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/monitoring/performance?endpoint=api%2Ftest%20with%20spaces');
      const response = await GET(request);
