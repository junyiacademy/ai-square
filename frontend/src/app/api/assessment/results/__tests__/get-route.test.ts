...
describe("GET /api/assessment/results", () => {
  ...
  it("should return 400 when neither userId nor userEmail is provided", async () => {
    const request = new NextRequest(
      "http://localhost:3000/api/assessment/results",
      {
        method: "GET",
      },
    );
  ...
  it("should return empty results when user not found by email", async () => {
    ...
    const request = new NextRequest(
      "http://localhost:3000/api/assessment/results?userEmail=notfound@example.com",
      {
        method: "GET",
      },
    );
  ...
  it("should return empty results when user not found by id", async () => {
    ...
    const request = new NextRequest(
      "http://localhost:3000/api/assessment/results?userId=notfound-id",
      {
        method: "GET",
      },
    );
  ...
  it("should return assessment results for valid user with email", async () => {
    ...
    const request = new NextRequest(
      "http://localhost:3000/api/assessment/results?userEmail=test@example.com",
      {
        method: "GET",
      },
    );
  ...
  it("should filter out non-assessment programs", async () => {
    ...
    expect(response.status).toBe(200);
    expect(mockEvaluationRepo.findByProgramIds).toHaveBeenCalledWith([
      "prog-2",
    ]);
    expect(data.data).toHaveLength(1);
  ...
  it("should sort results by timestamp (newest first)", async () => {
    ...
    const mockPrograms = [
      {
        id: "prog-1",
        scenarioId: "assessment-1",
        metadata: { type: "assessment" },
      },
      {
        id: "prog-2",
        scenarioId: "assessment-2",
        metadata: { type: "assessment" },
      },
    ];
    const mockEvaluations = [
