...
describe("GET /api/assessment/programs/[programId]/tasks/[taskId]", () => {
  ...
  describe("Parameter validation", () => {
    it("should validate program ID format", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/assessment/programs/invalid-id/tasks/" +
          VALID_UUID,
        {
          method: "GET",
        },
    ...
    it("should validate task ID format", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/assessment/programs/" +
          VALID_UUID +
          "/tasks/invalid-id",
        {
          method: "GET",
  ...
  describe("Error handling", () => {
    it("should handle repository errors gracefully", async () => {
      mockProgramRepo.findById.mockRejectedValueOnce(
  ...
  describe("Submit action", () => {
    ...
    it("should handle questions without correct answers", async () => {
      mockTaskRepo.findById.mockResolvedValueOnce({
        ...mockTask,
        content: {
          questions: [{ id: "q1", text: "Open question", options: [] }],
        },
      });
      ...
      const answers = [{ questionId: "q1", answer: "My answer" }];
