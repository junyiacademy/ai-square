...
jest.mock('@/components/homepage/TargetAudienceSection', () => ({
  TargetAudienceSection: () => <div data-testid="target-audience">Target Audience</div>
}));
...
describe('HomePage', () => {
  ...
  it('should render sections in correct order', () => {
    ...
    expect(sections[2]).toHaveAttribute('data-testid', 'how-it-works');
    expect(sections[3]).toHaveAttribute('data-testid', 'target-audience');
