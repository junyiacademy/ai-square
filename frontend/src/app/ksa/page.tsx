  ...
  return (
    <main className="p-8 bg-gray-50 min-h-screen">
        ...
        {[
          {
            ...
            label: `${t("sections.knowledge")} (${t("sections.knowledgeShort")})`,
            shortLabel: t("sections.knowledgeShort"),
            count: Object.keys(ksaData.knowledge_codes.themes).length,
          },
          {
            key: "skills" as const,
            label: `${t("sections.skills")} (${t("sections.skillsShort")})`,
            shortLabel: t("sections.skillsShort"),
            count: Object.keys(ksaData.skill_codes.themes).length,
          },
          {
            key: "attitudes" as const,
            label: `${t("sections.attitudes")} (${t("sections.attitudesShort")})`,
            shortLabel: t("sections.attitudesShort"),
            count: Object.keys(ksaData.attitude_codes.themes).length,
          },
        ].map((section) => (
          <button
            key={section.key}
      ...
      {searchTerm && (
        <div className="text-center mb-6">
          <p className="text-gray-600">
            {searchTerm
              ? t("results.themesFoundFor", {
                  count: Object.keys(
                    filterThemes(currentSectionData?.themes || {}),
                  ).length,
                  search: searchTerm,
                })
              : t("results.themesFound", {
                  count: Object.keys(
                    filterThemes(currentSectionData?.themes || {}),
                  ).length,
                })}
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        {currentSectionData &&
        Object.entries(filterThemes(currentSectionData.themes)).length === 0 ? (
          ...
          currentSectionData &&
          Object.entries(filterThemes(currentSectionData.themes)).map(
            ([themeKey, theme]) => (
