...
function ChatPageContent() {
        ...
        try {
          ...
          if (data.success && data.history) {
            ...
            setUserProgress({
              ...
              learningHours: history.reduce(
                (acc, h) => acc + h.timeSpent / 60,
                0,
              ),
  ...
  const getContextualQuickActions = () => {
      ...
      return [
        {
          ...
          prompt: "How do I start this scenario?",
        },
        {
          icon: "📊",
          label: "Difficulty",
          prompt: "Is this scenario appropriate for my level?",
        },
        {
          icon: "⏱️",
          label: "Time needed",
          prompt: "How long will this scenario take?",
        },
        {
          icon: "🎯",
          label: "Learning goals",
          prompt: "What will I learn from this scenario?",
        },
      ];
    }
      ...
      return [
        {
          icon: "📈",
          label: "Improve score",
          prompt: "How can I improve my assessment score?",
        },
        {
          icon: "🎯",
          label: "Weak areas",
          prompt: "What are my weakest areas I should focus on?",
        },
        {
          icon: "📚",
          label: "Study plan",
          prompt: "Can you create a study plan for me?",
        },
        {
          icon: "🔄",
          label: "Retake info",
          prompt: "When should I retake the assessment?",
        },
      ];
    }
      ...
      return [
        {
          icon: "💻",
          label: "Show example",
          prompt: "Can you show me a code example?",
        },
        {
          icon: "🐛",
          label: "Debug help",
        ...
        },
        {
          icon: "🔧",
          label: "Alternative",
          prompt: "Is there a better way to do this?",
        },
      ];
    }
    ...
    if (
      ...
      (aiContent.includes("ethic") ||
        aiContent.includes("bias") ||
        aiContent.includes("fair"))
    ) {
      return [
        {
          icon: "⚖️",
          label: "Ethical concerns",
          prompt: "What are the main ethical concerns here?",
        },
        {
          icon: "🛡️",
          label: "Mitigation",
          prompt: "How can we mitigate these risks?",
        },
        {
          icon: "📊",
          label: "Real cases",
          prompt: "Can you share real-world cases about this?",
        },
        {
          icon: "🌍",
          label: "Impact",
          prompt: "What is the societal impact of this?",
        },
      ];
    }
    ...
    if (
      userContent.includes("what") ||
      userContent.includes("how") ||
      userContent.includes("why")
    ) {
      return [
        {
          icon: "🎯",
        ...
        },
        {
          icon: "📊",
          label: "Compare",
          prompt: "How does this compare to similar concepts?",
        },
        {
          icon: "✅",
          label: "Check understanding",
          prompt: "Can you quiz me on this concept?",
        },
      ];
    }
  ...
  const [quickActions, setQuickActions] = useState<
    Array<{ icon: string; label: string; prompt: string }>
  >([]);
  ...
  const renderMobileLayout = () => (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex-1 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative">
        {/* Chat History Tab */}
        <div
          className={`absolute inset-0 ${mobileActiveTab === "history" ? "block" : "hidden"}`}
        >
        ...
        {/* Chat Tab */}
        <div
          className={`absolute inset-0 ${mobileActiveTab === "chat" ? "block" : "hidden"}`}
        >
                              ...
                              components={{
                                ...
                                code: ({ children, className }) => {
                                  ...
                                  return isInline ? (
                                    ...
                                    <code className="block p-3 bg-gray-800 text-gray-100 rounded-lg overflow-x-auto">
                                      {children}
                                    </code>
                                  );
                                },
        ...
        <div
          className={`absolute inset-0 ${mobileActiveTab === "resources" ? "block" : "hidden"}`}
        >
                      ...
                      <div>
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            ...
                            style={{
                              width: `${assessmentResult.overallScore}%`,
                            }}
                          />
                        </div>
                      </div>
