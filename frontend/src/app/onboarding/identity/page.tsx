        ...
        <div className="mb-8">
          <div className="flex items-center justify-center space-x-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm text-gray-600">{t('progress.welcome')}</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm font-medium text-gray-900">{t('progress.identity')}</span>
            </div>
            <div className="w-16 h-0.5 bg-gray-300"></div>
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm text-gray-500">{t('progress.goals')}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              {t('identity.subtitle', 'Help us personalize your AI learning journey')}
            </p>
          </div>
          ...
          <div className="flex justify-between">
            ...
            >
              {loading ? t('button.saving', 'Saving...') : t('button.continue', 'Continue')}
            </button>
          </div>
        </div>
      </div>
