      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">
                {t("terms.service.title", "2. Description of Service")}
              </h2>
              <p className="mb-4">
                {t("terms.service.intro", "AI Square provides:")}
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  {t(
                    "terms.service.literacy",
                    "AI literacy education content and assessments",
                  )}
                </li>
                <li>
                  {t(
                ...
                <li>
                  {t("terms.service.ai", "AI-powered tutoring and feedback")}
                </li>
                <li>
                  {t(
                    "terms.service.tracking",
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">
                {t("terms.accounts.title", "3. User Accounts")}
              </h2>

              <h3 className="text-xl font-medium mb-3">
                {t("terms.accounts.registration", "Registration")}
              </h3>
              <ul className="list-disc pl-6 mb-4 space-y-2">
                <li>
                  {t(
                    "terms.accounts.accurate",
                    "Provide accurate and complete information",
                  )}
                </li>
                <li>
                  {t(
                    "terms.accounts.maintain",
                    "Maintain and update your information",
                  )}
                </li>
                <li>
                  {t(
                    "terms.accounts.secure",
                    "Keep your account credentials secure",
                  )}
                </li>
                <li>
                  {t(
                    "terms.accounts.responsible",
              ...
              <h3 className="text-xl font-medium mb-3">
                {t("terms.accounts.types", "Account Types")}
              </h3>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  {t(
                    "terms.accounts.student",
                    "Student: Access to learning content and assessments",
                  )}
                </li>
                <li>
                  {t(
                    "terms.accounts.teacher",
                    "Teacher: Additional class management features",
                  )}
                </li>
                <li>
                  {t(
                    "terms.accounts.admin",
                    "Administrator: Platform management capabilities",
                  )}
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">
                {t("terms.use.title", "4. Acceptable Use Policy")}
              </h2>

              <h3 className="text-xl font-medium mb-3">
                {t("terms.use.permitted", "You may:")}
              </h3>
              <ul className="list-disc pl-6 mb-4 space-y-2">
                <li>
                  {t(
                    "terms.use.educational",
                ...
                <li>
                  {t(
                    "terms.use.share",
                    "Share your learning progress appropriately",
                  )}
                </li>
                <li>
                  {t("terms.use.feedback", "Provide constructive feedback")}
                </li>
              </ul>

              <h3 className="text-xl font-medium mb-3">
                {t("terms.use.prohibited", "You may not:")}
              </h3>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  {t(
                    "terms.use.misuse",
                    "Misuse or attempt to manipulate the AI systems",
                  )}
                </li>
                <li>
                  {t(
                    "terms.use.share_credentials",
                    "Share account credentials",
                  )}
                </li>
                <li>{t("terms.use.cheat", "Engage in academic dishonesty")}</li>
                <li>
                  {t("terms.use.harm", "Harass, abuse, or harm other users")}
                </li>
                <li>
                  {t(
                    "terms.use.illegal",
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-medium mb-3">
                {t("terms.ip.platform", "Platform Content")}
              </h3>
              <p className="mb-4">
                {t(
                  "terms.ip.ownership",
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">
                {t("terms.privacy.title", "6. Privacy and Data Protection")}
              </h2>
              <p>
                {t(
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">
                {t("terms.ai.title", "7. AI Services and Limitations")}
              </h2>
              <p className="mb-4">
                {t(
                  "terms.ai.disclaimer",
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  {t(
                    "terms.ai.improve",
                    "We continuously work to improve AI accuracy",
                  )}
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">
                {t("terms.disclaimers.title", "8. Disclaimers and Limitations")}
              </h2>
              <p className="mb-4 uppercase font-semibold">
                {t(
                  "terms.disclaimers.asis",
                  'THE SERVICE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND.',
                )}
              </p>
              <p className="mb-4">
                {t(
                  "terms.disclaimers.liability",
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">
                {t("terms.contact.title", "12. Contact Information")}
              </h2>
              <p className="mb-4">
                {t(
                  "terms.contact.intro",
          ...
          <div className="mt-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <p className="text-center text-gray-700 dark:text-gray-300 mb-4">
              {t(
                "terms.agreement",
                "By using AI Square, you acknowledge that you have read and agree to these Terms of Service.",
              )}
            </p>
          </div>
