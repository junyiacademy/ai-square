...
export function isAssessmentScenario(
  scenario: IScenario,
): scenario is IAssessmentScenario {
  return scenario.mode === "assessment";
}

export function isDiscoveryScenario(
  scenario: IScenario,
): scenario is IDiscoveryScenario {
...
export function isPBLEvaluation(
  evaluation: IEvaluation,
): evaluation is IPBLEvaluation {
  return evaluation.evaluationSubtype?.startsWith("pbl_") || false;
}

export function isAssessmentEvaluation(
  evaluation: IEvaluation,
): evaluation is IAssessmentEvaluation {
  return evaluation.evaluationSubtype?.startsWith("assessment_") || false;
}

export function isDiscoveryEvaluation(
  evaluation: IEvaluation,
): evaluation is IDiscoveryEvaluation {
