  ...
  describe("QualitativeFeedback interface", () => {
    it("should define complete qualitative feedback structure", () => {
      const feedback: QualitativeFeedback = {
        overallAssessment:
          "You demonstrated strong analytical skills throughout this scenario.",
        strengths: [
          {
            area: "Critical Thinking",
        ...
        encouragement:
          "Your progress in AI literacy is remarkable. Keep exploring!",
      };
    ...
    it("should allow minimal feedback with only assessment", () => {
      ...
      expect(minimalFeedback.overallAssessment).toBe(
        "Good work on this scenario.",
      );
    ...
    it("should define multi-language feedback structure", () => {
      const localizedFeedback: LocalizedFeedback = {
        ...
        es: {
          ...
          strengths: [
            { area: "Análisis", description: "Evaluación exhaustiva" },
          ],
  ...
  describe("ConversationExample interface", () => {
    it("should define conversation example structure", () => {
      const example: ConversationExample = {
        ...
        suggestion:
          "This shows good ethical reasoning. Consider also discussing specific scenarios where this might apply.",
      };
  ...
  describe("TaskInteraction interface", () => {
    it("should define task interaction structure", () => {
      ...
      const assistantInteraction: TaskInteraction = {
        type: "assistant",
        message:
          "That's an excellent point. Can you elaborate on which stakeholders?",
          ...
          attitudes: [
            {
              ...
              description: "Sensitivity to ethics",
            },
          ],
        },
        tasks: [
