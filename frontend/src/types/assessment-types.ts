 ...
 */
export interface AssessmentInteraction extends Omit<
  IInteraction,
  "type" | "content"
> {
...
export function isAssessmentInteraction(
  ...
  return (
    (interaction as AssessmentInteraction).type === "assessment_answer" &&
 ...
 */
export function toIInteraction(
 ...
 */
export function fromIInteraction(
  interaction: IInteraction,
): AssessmentInteraction | null {
  if (
    interaction.type === "system_event" &&
