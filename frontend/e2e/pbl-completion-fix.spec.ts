...
test("PBL Completion page displays correctly with multilingual fields", async ({
  page,
}) => {
  // Step 1: Login first
  ...
  await page.goto(
    "http://localhost:3000/pbl/scenarios/a5e6c365-832a-4c8e-babb-9f39ab462c1b/programs/364b6133-5a32-443b-bfc1-28f5f745a75e/complete",
  );
  ...
  const errorMessages = await page
    .locator("text=/Objects are not valid as a React child/i")
    .count();
