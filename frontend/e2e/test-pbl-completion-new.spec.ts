...
test("PBL Completion page with new program displays correctly", async ({
  page,
}) => {
  // Step 1: Login first
  ...
  await page.goto(
    "http://localhost:3000/pbl/scenarios/a5e6c365-832a-4c8e-babb-9f39ab462c1b/programs/003bcf30-f8c2-4e23-8108-3ad51e74672a/complete",
  );
