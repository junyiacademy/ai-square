...
test('PBL task title displays correctly', async ({ page }) => {
  ...
  await page.goto('http://localhost:3000/pbl/scenarios/a5e6c365-832a-4c8e-babb-9f39ab462c1b/programs/4a077099-200f-4e88-8849-e04d3856a3e3/tasks/7352074f-6926-44e3-855d-3f6673413917');
  ...
  await page.screenshot({ path: 'task-title-verification.png', fullPage: false });
});