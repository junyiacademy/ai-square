...
test.describe("Login and Session E2E Test - Staging", () => {
  test("should login successfully and maintain session across protected routes", async ({
    page,
  }) => {
    ...
    console.log(
      "🍪 AccessToken cookie:",
      accessTokenCookie ? "Present" : "Missing",
    );
    console.log(
      "🍪 All cookies:",
    ...
    console.log(
      "📍 Current URL after /assessment/scenarios:",
      assessmentScenariosUrl,
    );
